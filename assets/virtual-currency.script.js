...
const vcMain = document.querySelector("main.virtual-currency");

gsap.set(titleContainer, { autoAlpha: 0 });
gsap.set(vcMain, { autoAlpha: 0 });
  ...
  introMatch.add(
    ...
    (context) => {
      ...
      revealHeader
        ...
        .to(vcMain, speed, { autoAlpha: 1 }, `-=${0.7}`)
        .to(
          ".hero-text-inner",
          {
            autoAlpha: 1,
...
let vcGallery = new Swiper(".virtual-currency-gallery-swiper", {
  slidesPerView: 1,
  spaceBetween: 5,
  slidesPerGroup: 1,
  loop: true,
...
let vcPhotos = gsap.utils.toArray(".virtual-currency-img");
