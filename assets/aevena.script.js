...
const aevenaMain = document.querySelector("main.aevena");

gsap.set(titleContainer, { autoAlpha: 0 });
gsap.set(aevenaMain, { autoAlpha: 0 });
  ...
  introMatch.add(
    ...
    (context) => {
      ...
      revealHeader
        ...
        .to(aevenaMain, speed, { autoAlpha: 1 }, `-=0.7`)
        .to(
          ".hero-text-inner",
          {
            autoAlpha: 1,
      ...
      fadeUp.forEach((container) => {
        gsap.set(container, { y: 150 });
        gsap.to(container, {
          autoAlpha: 1,
          y: 0,
          scrollTrigger: {
            trigger: container,
            start: isTiny ? "top 98%" : "top 90%",
            end: isTiny ? "95% 75%" : "bottom 85%",
            scrub: true,
            ease: "none",
          },
        });
...
//! galleries...
let aevenaGalleryFinal = new Swiper(".aevena-final-gallery-swiper", {
  slidesPerView: 1,
  spaceBetween: 5,
  slidesPerGroup: 1,
  loop: true,
...
let aevenaFinalPhotos = gsap.utils.toArray(".aevena-final-img");

//! #2

let aevenaGalleryUI = new Swiper(".aevena-ui-gallery-swiper", {
  slidesPerView: 3,
  spaceBetween: 5,
  slidesPerGroup: 3,
  loop: true,
...
let aevenaUIPhotos = gsap.utils.toArray(".aevena-ui-img");

//! #3
let aevenaGalleryUIDev = new Swiper(".aevena-ui-dev-gallery-swiper", {
  slidesPerView: 1,
  spaceBetween: 5,
  slidesPerGroup: 1,
  loop: true,
...
let aevenaUIDevPhotos = gsap.utils.toArray(".aevena-ui-dev-img");
...
galleryInit(aevenaFinalPhotos);
galleryInit(aevenaUIPhotos);
galleryInit(aevenaUIDevPhotos);
